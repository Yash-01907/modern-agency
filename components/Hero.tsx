  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 px-6 mx-auto text-center text-white">
        <h1
          ref={titleRef}
          className="font-display font-bold text-5xl sm:text-6xl md:text-8xl lg:text-9xl tracking-tight leading-[0.98] md:leading-[0.9] mb-8"
        >
          ...
          <br />
          <span className="inline-block overflow-hidden pb-4">
            <span className="word inline-block text-gray-500">Reimagined</span>
          </span>
        </h1>
